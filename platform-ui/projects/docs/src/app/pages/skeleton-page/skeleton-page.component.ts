...
<pui-lib-skeleton variant="text" animated="false"></pui-lib-skeleton>`;
  ...
  xfwRows = [
    ...
    {
      name: 'animated',
      angular: '[animated]="false"',
      attr: 'animated="false"',
      js: 'el.animated = false',
    },
  ];
  ...
  api: ApiRow[] = [
    ...
    },
    {
      ...
      type: 'string',
      default: `'100%'`,
      description: 'CSS width of the skeleton (e.g. "320px", "50%").',
    },
    {
      input: 'height',
      type: 'string',
      default: `'16px'`,
      description: 'CSS height. Ignored for circle (diameter = width) and card variants.',
    },
    {
      input: 'rows',
      type: 'number',
      default: '1',
      description: 'Number of skeleton rows to render. Useful for paragraph placeholders.',
    },
    {
      input: 'animated',
      type: 'boolean',
      default: 'true',
      description: 'Enables the shimmer sweep animation.',
    },
  ];
