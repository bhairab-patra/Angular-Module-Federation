...
<script>
  ...
  xfwRows = [
    ...
    {
      name: 'fullWidth',
      angular: '[fullWidth]="true"',
      attr: 'full-width',
      js: 'el.fullWidth = true',
    },
    {
      name: 'progress',
      angular: '[progress]="pct"',
      attr: 'progress="50"',
      js: 'el.progress = 50',
    },
    {
  ...
  api: ApiRow[] = [
    {
      input: 'variant',
      type: `'primary'|'primary-light'|'primary-outline'|'secondary'|'secondary-light'|'tertiary-outline'|'text'|'destructive'|'destructive-light'|'chip'|'upload-progress'`,
      default: `'primary'`,
    ...
    },
    {
      ...
      type: 'string',
      default: 'undefined',
      description: 'Dynamic text label rendered inside the button; overrides ng-content when set.',
    },
    {
      input: 'size',
      type: `'sm'|'md'|'lg'`,
      default: `'md'`,
      description: 'Button size — scales padding and font.',
    },
    {
      input: 'disabled',
      type: 'boolean',
    ...
    },
    {
      ...
      type: 'boolean',
      default: 'false',
      description: 'Shows a spinner and blocks click events.',
    },
    {
      input: 'progress',
      type: 'number (0–100)',
      default: '0',
      description: 'Upload fill percentage (variant="upload-progress" only).',
    },
    {
      input: 'fullWidth',
      type: 'boolean',
    ...
    },
    {
      ...
      default: '—',
      description: 'Fired on click — suppressed when disabled or loading.',
    },
    {
      input: '(buttonFocus)',
    ...
    },
    {
      ...
      type: 'EventEmitter<MouseEvent>',
      default: '—',
      description: 'Fired on mouseenter.',
    },
    {
      input: '(buttonLeave)',
      type: 'EventEmitter<MouseEvent>',
      default: '—',
      description: 'Fired on mouseleave.',
    },
  ];
}
