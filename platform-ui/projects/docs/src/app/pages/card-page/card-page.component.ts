...
<script>
  ...
  xfwRows = [
    ...
    {
      name: 'clickable',
      angular: '[clickable]="true"',
      attr: 'clickable',
      js: 'el.clickable = true',
    },
  ...
  api: ApiRow[] = [
    {
      ...
      default: 'undefined',
      description:
        'Renders stat/metric layout automatically (title, value, trend, trendValue, subtitle).',
    },
    {
      input: 'variant',
      type: `'default'|'outlined'|'flat'|'teal'|'dark'`,
      default: `'default'`,
    ...
    },
    {
      ...
      type: `'sm'|'md'|'lg'`,
      default: `'md'`,
      description: 'Internal padding — sm 16px, md 24px, lg 32px.',
    },
    { input: 'elevated', type: 'boolean', default: 'true', description: 'Drop-shadow.' },
    {
      ...
      type: 'boolean',
      default: 'false',
      description: 'Hover lift + pointer cursor.',
    },
    {
      input: 'fullWidth',
      type: 'boolean',
    ...
    },
    {
      ...
      type: 'boolean',
      default: 'false',
      description: 'Teal gradient top-border accent strip.',
    },
    {
      input: 'cardClass',
      type: 'string',
      default: `''`,
      description: 'Extra CSS class on the wrapper element.',
    },
    {
      input: '(cardClick)',
      type: 'EventEmitter<MouseEvent>',
      default: '—',
      description: 'Emitted on click when clickable=true.',
    },
  ];
