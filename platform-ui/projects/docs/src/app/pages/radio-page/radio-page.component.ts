...
export class RadioPageComponent {
  ...
  xfwRows = [
    ...
    {
      name: 'options',
      angular: '[options]="optionsArray"',
      attr: '— use JS property',
      js: 'el.options = [{label,value}]',
    },
    {
      name: 'disabled',
    ...
    {
      name: 'direction',
      angular: 'direction="vertical|horizontal"',
      attr: 'direction="horizontal"',
      js: 'el.direction = "horizontal"',
    },
    {
      name: 'valueChange',
...
<script>
  ...
  api: ApiRow[] = [
    ...
    },
    {
      ...
      type: 'RadioOption[]',
      default: '[]',
      description: 'Array of { label, value, hint?, disabled? }',
    },
    {
      input: 'disabled',
      type: 'boolean',
    ...
    },
    {
      ...
      type: 'boolean',
      default: 'false',
      description: 'Shows required asterisk on the legend',
    },
    {
      input: 'error',
      type: 'string',
    ...
    },
    {
      ...
      type: 'string',
      default: 'auto',
      description: 'HTML name attribute for radio inputs (auto-generated)',
    },
    {
      input: 'valueChange',
