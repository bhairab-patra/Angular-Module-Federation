...
export class MenuPageComponent {
  ...
  submenuItems: MenuItem[] = [
    ...
    },
    {
      id: 'delete',
      label: 'Delete',
      icon: ICON('<polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14H6L5 6"/>'),
      danger: true,
    },
  ];
  ...
  fwReactItems: MenuItem[] = [
    {
      id: 'profile',
      label: 'My Profile',
      icon: ICON('<circle cx="12" cy="8" r="5"/><path d="M3 21a9 9 0 0 1 18 0"/>'),
    },
    {
      id: 'settings',
      label: 'Account Settings',
      icon: ICON(
        '<circle cx="12" cy="12" r="3"/><path d="M12 1v3M12 20v3M4.22 4.22l2.12 2.12M17.66 17.66l2.12 2.12M1 12h3M20 12h3"/>',
      ),
    },
    {
      id: 'billing',
  ...
  fwLastAction = '';
  onFwSelect(item: MenuItem): void {
    this.fwLastAction = item.label;
    this.cdr.markForCheck();
  }
...
<script>
  ...
  xfwRows = [
    ...
    {
      name: 'trigger',
      angular: 'trigger="Actions"',
      attr: 'trigger="Actions"',
      js: 'el.trigger = "Actions"',
    },
    {
      name: 'variant',
      angular: 'variant="outline"',
      attr: 'variant="outline"',
      js: 'el.variant = "outline"',
    },
    {
      name: 'placement',
      angular: 'placement="bottom-end"',
      attr: 'placement="..."',
      js: 'el.placement = "..."',
    },
    {
  ...
  api: ApiRow[] = [
    {
      ...
      type: 'MenuItem[]',
      default: '[]',
      description: 'Array of menu items. Each item may have nested children for a submenu.',
    },
    {
      input: 'trigger',
      type: 'string',
      default: "'Menu'",
      description: 'Label displayed inside the trigger button when no ng-content is projected.',
    },
    {
      input: 'variant',
      type: "'default'|'outline'|'ghost'|'primary'",
      default: "'default'",
    ...
    },
    {
      ...
      description: 'Which corner of the trigger the dropdown panel opens from.',
    },
    {
      input: 'disabled',
      type: 'boolean',
    ...
    },
    {
      ...
      type: 'number',
      default: '320',
      description: 'Max pixel height of the dropdown panel before it scrolls.',
    },
    {
      input: 'menuSelect',
      ...
      default: '—',
      description:
        'Emits the clicked MenuItem. Only fires for leaf items (not parent items with children).',
    },
  ];
}
