...
<pui-lib-label
  ...
  xfwRows = [
    {
      name: 'text',
      angular: 'text="Full Name"',
      attr: 'text="Full Name"',
      js: 'el.text = "Full Name"',
    },
    ...
    {
      name: 'info',
      angular: 'info="Hint text…"',
      attr: 'info="Hint text…"',
      js: 'el.info = "Hint text…"',
    },
    {
      name: 'infoPosition',
      angular: 'infoPosition="right"',
      attr: 'info-position="right"',
      js: 'el.infoPosition = "right"',
    },
  ];
  ...
  api: ApiRow[] = [
    { input: 'text', type: 'string', default: "''", description: 'The label text.' },
    {
      ...
      default: 'false',
      description:
        "Shows a red asterisk after the text — purely visual, does not affect the paired input's own validation.",
    },
    {
      input: 'showInfo',
      type: 'boolean|string',
      default: 'false',
      description:
        "Whether the info icon and its hover tooltip render at all. Off by default — only turn it on when there's actually a hint worth showing.",
    },
    {
      input: 'info',
      type: 'string',
      default: "''",
      description:
        'Tooltip text shown when hovering the info icon. Has no effect unless showInfo is true.',
    },
    {
      input: 'infoPosition',
      type: `'top'|'bottom'|'left'|'right'`,
      default: `'top'`,
      description: 'Which side of the info icon the tooltip bubble opens on.',
    },
  ];
