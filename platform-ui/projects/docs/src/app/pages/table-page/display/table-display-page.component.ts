  ...
  empActions: TableAction[] = [
    {
      label: 'Add Employee',
      action: (row) => {
        this.lastAction = `Add Employee above: ${row.name}`;
        this.cdr.markForCheck();
      },
    },
    {
    ...
    },
    {
      ...
      action: (row) => {
        this.lastAction = `Remove: ${row.name}`;
        this.cdr.markForCheck();
      },
...
<script>
  ...
  api: ApiRow[] = [
    ...
    },
    {
      ...
      type: 'any[]',
      default: '[]',
      description: 'Row data array; each key must match a column key',
    },
    {
      input: 'heading',
      type: 'string',
    ...
    },
    {
      ...
      type: 'boolean',
      default: 'false',
      description: 'Enables column-level sort toggling (asc → desc → none)',
    },
    {
      input: 'stickyHeader',
      type: 'boolean',
    ...
    },
    {
      ...
      default: '—',
      description: 'Emits active sort key and direction on each toggle',
    },
    {
      input: 'searchChange',
    ...
    },
    {
      ...
      default: '—',
      description:
        'pui-lib-table has no actions/actionClick — for a per-row 3-dot action menu, use pui-lib-data-table (same columns/data shape, plus [actions] and (actionClick)).',
    },
  ];
}
