...
export class TableDataGridPageComponent {
  ...
  /* Status renders as a neutral Chip/Badge here — status colors are reserved
     for the Loading State demo below (see employeeColsLoading) so regular
     tables don't carry semantic color coding. */
  ...
  /* Same data, colored status — used only by the Loading State demo. */
