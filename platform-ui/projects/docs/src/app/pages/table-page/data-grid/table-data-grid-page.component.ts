...
export class TableDataGridPageComponent {
  ...
  isLoading = false;
  dialogLog: string[] = [];
  emptyRows: Record<string, unknown>[] = [];
  emptyActionLog = '';
  ...
  onAddFromEmptyState(): void {
    this.emptyActionLog = 'Add Employee clicked';
    this.cdr.markForCheck();
  }
  ...
  employeeColsLoading: TableColumn[] = [
    ...this.employeeCols.slice(0, 4),
    {
      key: 'status',
      label: 'Status',
      sortable: true,
  ...
  products = Array.from({ length: 22 }, (_, i) => {
    const stocks = [
      48, 12, 0, 35, 5, 23, 0, 67, 89, 4, 11, 29, 52, 108, 0, 19, 37, 14, 61, 3, 26, 45,
    ];
    const s = stocks[i];
    return {
      ...
      stock: s,
      price: [
        79.99, 129.99, 49.99, 39.99, 99.99, 29.99, 24.99, 59.99, 14.99, 349.99, 599.99, 79.99,
        19.99, 9.99, 8.99, 34.99, 44.99, 29.99, 39.99, 12.99, 49.99, 39.99,
      ][i],
  ...
  dialogActions: TableAction[] = [
    {
      ...
      action: (_row) => {
        ...
        this.dialogSaveLabel = 'Add Product';
        this.dialogData = {};
    ...
    },
    {
      ...
      action: (row) => {
        ...
        this.dialogSaveLabel = 'Save Changes';
        this.dialogData = { ...row };
        this.dialogOpen = true;
        this.cdr.markForCheck();
      },
  ...
  onDialogSave(e: FormDialogSaveEvent): void {
    this.dialogLog = [
      `${this.dialogTitle}: ${String(e.data['name'])}`,
      ...this.dialogLog.slice(0, 4),
    ];
  ...
  onConfirmDelete(): void {
    if (this.confirmRow)
      this.dialogLog = [
        `Deleted: ${String(this.confirmRow['name'])}`,
        ...this.dialogLog.slice(0, 4),
      ];
...
export class MyComponent {
  ...
  xfwRows = [
    ...
    {
      name: 'heading',
      angular: '[heading]="\'Account Summary\'"',
      attr: 'heading="Account Summary"',
      js: 'el.heading = "Account Summary"',
    },
    {
      name: 'searchable',
      angular: '[searchable]="bool"',
      attr: 'searchable="true"',
      js: 'el.searchable = true',
    },
    {
      name: 'sortable',
      angular: '[sortable]="bool"',
      attr: 'sortable="true"',
      js: 'el.sortable = true',
    },
    {
      name: 'paginated',
      angular: '[paginated]="bool"',
      attr: 'paginated="true"',
      js: 'el.paginated = true',
    },
    {
      name: 'pageSize',
      angular: '[pageSize]="10"',
    ...
    {
      name: 'selectable',
      angular: '[selectable]="bool"',
      attr: 'selectable="true"',
      js: 'el.selectable = true',
    },
    {
      name: 'stickyHeader',
      angular: '[stickyHeader]="bool"',
      attr: 'sticky-header="true"',
    ...
    {
      name: 'actions',
      angular: '[actions]="actionsArray"',
      attr: '— use JS property',
      js: 'el.actions = [{label,action}]',
    },
    {
      name: 'emptyTitle',
      angular: '[emptyTitle]="\'…\'"',
    ...
    },
    {
      ...
      angular: '[emptyDescription]="\'…\'"',
      attr: 'empty-description="…"',
      js: 'el.emptyDescription = "…"',
    },
    {
    ...
    {
      name: 'rowClick',
      angular: '(rowClick)="fn($event)"',
      attr: '— use addEventListener',
      js: 'el.addEventListener("rowClick", fn)',
    },
    {
      name: 'selectionChange',
      angular: '(selectionChange)="fn($event)"',
      attr: '— use addEventListener',
      js: 'el.addEventListener("selectionChange", fn)',
    },
    {
      name: 'pageChange',
      angular: '(pageChange)="fn($event)"',
      attr: '— use addEventListener',
      js: 'el.addEventListener("pageChange", fn)',
    },
    {
      name: 'sortChange',
  ...
  api: ApiRow[] = [
    {
      ...
      type: 'TableColumn[]',
      default: '[]',
      description: 'Column definitions: key, label, sortable, width, align, type, badgeMap',
    },
    { input: 'data', type: 'any[]', default: '[]', description: 'Row data array' },
    {
      ...
      type: 'string',
      default: "''",
      description: 'Optional title on the left of the toolbar; omit to hide it',
    },
    {
      input: 'headingIcon',
      type: 'string',
      default: "''",
      description:
        'Optional icon name shown in a square icon-button before the heading; omit for no icon',
    },
    {
      input: 'searchable',
      type: 'boolean',
      default: 'false',
      description: 'Shows a global search/filter input in the toolbar; leave false to hide it',
    },
    {
      input: 'sortable',
      type: 'boolean',
      default: 'false',
      description: 'Enables column-level sort toggling',
    },
    {
      input: 'paginated',
      type: 'boolean',
      default: 'false',
      description: 'Enables pagination controls at the bottom',
    },
    { input: 'pageSize', type: 'number', default: '10', description: 'Initial rows per page' },
    {
      ...
      type: 'boolean',
      default: 'false',
      description: 'Shows checkboxes for row selection with select-all header',
    },
    {
      input: 'stickyHeader',
      type: 'boolean',
      default: 'false',
      description: 'Freezes the header row while the body scrolls',
    },
    {
      input: 'maxHeight',
      type: 'number',
      default: '0',
      description: 'Max height (px) of the scroll container; 0 = no limit',
    },
    {
      input: 'striped',
      type: 'boolean',
      default: 'false',
      description: 'Alternating row background shading',
    },
    {
      input: 'loading',
      type: 'boolean',
      default: 'false',
      description: 'Overlays a shimmer skeleton while data is fetching',
    },
    {
      input: 'emptyTitle',
      type: 'string',
      default: "''",
      description: 'Overrides the default "No data available" empty-state message',
    },
    {
      input: 'emptyDescription',
      type: 'string',
      default: "''",
      description: 'Optional supporting text under the empty-state title',
    },
    {
      input: 'actions',
      type: 'TableAction[]',
      default: '[]',
      description: 'Row-level actions shown in a 3-dot dropdown menu',
    },
    {
      input: 'tooltipPosition',
      type: "'top'|'bottom'|'left'|'right'",
      default: "'right'",
      description: 'Direction of the cell overflow tooltip',
    },
    {
      input: 'rowClick',
      type: 'EventEmitter<any>',
      default: '—',
      description: 'Emits the clicked row object',
    },
    {
      input: 'selectionChange',
      type: 'EventEmitter<any[]>',
      default: '—',
      description: 'Emits the full array of currently selected rows',
    },
    {
      input: 'pageChange',
      type: 'EventEmitter<number>',
      default: '—',
      description: 'Emits the new page number',
    },
    {
      input: 'sortChange',
      type: 'EventEmitter<{key,dir}>',
      default: '—',
      description: 'Emits the active sort key and direction',
    },
    {
      input: 'searchChange',
    ...
    {
      input: 'actionClick',
      type: 'EventEmitter<{action,row}>',
      default: '—',
      description: 'Emits when an action menu item is clicked',
    },
  ];
}
