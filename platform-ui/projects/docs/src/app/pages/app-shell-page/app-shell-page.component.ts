...
const NAV_GROUPS: SolifiNavGroup[] = [
  ...
  },
  {
    id: 'user-setup',
    label: 'User Setup',
    items: [{ id: 'user-setup', label: 'User Setup', iconName: 'users' }],
  },
];
...
export class AppShellPageComponent {
  ...
  referenceItems: AccordionItem[] = [
    {
      ...
      contentHtml: refTable([
        [
          'sidebarGroups',
          'SolifiNavGroup[]|SolifiNavItem[]',
          '[]',
          'Nav items/groups in the sidebar — accepts a flat array or grouped array with section labels.',
        ],
        ['sidebarActiveId', 'string', "''", 'Id of the currently highlighted nav item.'],
        [
          'sidebarBrandName / sidebarLogoUrl',
          'string',
          "'solifi' / ''",
          "Sidebar's brand text and logo image.",
        ],
        [
          'showSidebarBrand',
          'boolean|string',
          'true',
          'Show/hide the sidebar logo section entirely (expanded and collapsed).',
        ],
        [
          'sidebarCollapsed',
          'boolean|string',
          'false',
          'Collapses the sidebar to a 64px icon rail. Bind it two-way with (sidebarCollapsedChange) to stay in sync.',
        ],
        [
          'showSidebar',
          'boolean|string',
          'true',
          'Hides the sidebar completely, e.g. for a mobile flat layout.',
        ],
        [
          'sidebarWidth / sidebarCollapsedWidth',
          'number',
          '220 / 64',
          "Sidebar's expanded and collapsed pixel widths.",
        ],
        [
          'sidebarTheme',
          'SolifiSidebarTheme|string',
          'SOLIFI_THEME',
          'Full sidebar colour-token object (background, text, active colours).',
        ],
        [
          'pageTitle',
          'string',
          "''",
          'Shell-level (not sidebar or header specific) — title shown in the bar under the header.',
        ],
        [
          'footerText',
          'string',
          "''",
          'Shell-level — text for the bottom footer bar; only renders when non-empty.',
        ],
      ]),
    },
    {
      ...
      contentHtml: refTable([
        [
          ...
          'boolean|string',
          'false',
          'Shows the user-profile strip at the bottom of the sidebar.',
        ],
        [
          'sidebarUserName / sidebarUserEmail',
          'string',
          "'' / ''",
          'Name and email shown in that strip.',
        ],
        [
          'sidebarUserInitials',
          'string',
          "''",
          'Avatar-bubble initials; auto-derived from sidebarUserName if left unset.',
        ],
        [
          'sidebarUserAvatarUrl',
          'string',
          "''",
          'Avatar photo URL — falls back to the initials bubble when unset.',
        ],
        [
          'sidebarUserMenuItems',
          'SolifiUserMenuItem[]|string',
          '[]',
          "Dropdown items shown when the sidebar's user strip is clicked.",
        ],
      ]),
    },
    {
      ...
      contentHtml: refTable([
        [
          ...
          'boolean|string',
          'false',
          'Renders the full pui-lib-footer component instead of the plain footerText bar. Only one footer ever renders at once — turning this on ignores footerText.',
        ],
        [
          'footerVariant',
          `'contact'|'disclaimer'|'simple'`,
          "'simple'",
          'Which footer layout to render — contact shows office-hours/address + CTA, disclaimer shows body text + "read more" link, simple shows just the copyright/links bar.',
        ],
        [
          'footerNoticeSlides',
          'FooterNoticeSlide[]|string',
          '[]',
          'Rotating notice-card slides shown above the copyright bar (contact/disclaimer variants). Each slide only uses the fields its variant needs.',
        ],
        [
          'footerActiveSlideIndex',
          'number|string',
          '0',
          'Index of the currently visible notice slide. Bind two-way with (footerActiveSlideIndexChange) to sync rotation state.',
        ],
        [
          'footerCopyrightText',
          'string',
          "'Copyright © {year} Solifi. All Rights Reserved.'",
          'Copyright line shown in the footer bar. Independent of the shell-level footerText (that one is for the plain bar, this one is for the rich footer).',
        ],
        [
          'footerLinks',
          'FooterLink[]|string',
          '[]',
          'Bottom-row links (label + href or action) — e.g. Privacy Policy, Terms of Service.',
        ],
        [
          'footerPoweredByText',
          'string',
          "'Powered by Solifi™'",
          'Small "powered by" label shown alongside the copyright line.',
        ],
        [
          'showFooterPoweredBy',
          'boolean|string',
          'true',
          'Show/hide the "powered by" label entirely.',
        ],
        [
          'footerStickyBottom',
          'boolean|string',
          'false',
          'Pins the footer to the bottom of the viewport (position: fixed) instead of letting it flow after your page content. The shell auto-reserves space so content never sits underneath it.',
        ],
        [
          'footerActiveSlideIndexChange',
          'EventEmitter<number>',
          '—',
          'Fires when the active notice slide changes (auto-rotation or manual nav).',
        ],
        [
          'footerLinkClick',
          'EventEmitter<FooterLink>',
          '—',
          'Fires when a bottom-row footer link is clicked.',
        ],
        [
          'footerContactClick',
          'EventEmitter<FooterNoticeSlide>',
          '—',
          "Fires when the contact variant's call-to-action button is clicked.",
        ],
      ]),
    },
    {
      ...
      contentHtml: refTable([
        [
          ...
          'boolean|string',
          'true',
          'Master switch for the whole header. false = flat layout, no header bar.',
        ],
        [
          'headerAppTitle / headerAppSubtitle',
          'string',
          "'' / ''",
          "Header's title and subtitle text.",
        ],
        [
          'headerLogoUrl / headerLogoText',
          'string',
          "'' / ''",
          "Header's own logo image and/or text label, independent of the sidebar logo.",
        ],
        [
          'headerBgColor / headerTextColor',
          'string',
          'theme tokens',
          "Colour overrides — default to the current theme's header tokens.",
        ],
        [
          'showHeaderLogo / showHeaderHeading / showHeaderSearch / showHeaderUser',
          'boolean|string',
          'true (each)',
          "Toggle each of the header's four sections on or off individually.",
        ],
        [
          'headerAvatarMode',
          `'menu'|'plain'`,
          "'menu'",
          '"menu" = name/email + dropdown, "plain" = round avatar chip only, no dropdown.',
        ],
        [
          'headerUserName / headerUserEmail / headerAvatarUrl',
          'string',
          "'' / '' / ''",
          "Header avatar's own identity — separate from the sidebar's sidebarUserName/sidebarUserEmail.",
        ],
        [
          'headerAvatarColor / headerAvatarTextColor',
          'string',
          'theme tokens',
          "Avatar chip's background and initials colour.",
        ],
        [
          'headerMenuItems',
          'UserMenuItem[]|string',
          '[]',
          "Header avatar dropdown items (menu mode only) — shape {label, icon, action}, not interchangeable with the sidebar's sidebarUserMenuItems.",
        ],
        [
          'headerBadge',
          'HeaderBadge|string|null',
          'null',
          'Optional environment badge (e.g. "UAT"/"PROD") shown in the header.',
        ],
      ]),
    },
    {
      ...
      contentHtml: refTable(
        [
          ...
          [
            'sidebarUserMenuSelect',
            'EventEmitter<SolifiUserMenuItem>',
            '—',
          ...
          [
            ...
            'EventEmitter<string>',
            '—',
            'Fires when a header avatar dropdown item is clicked (only if headerMenuItems is set).',
          ],
        ],
  ...
  onReferenceOpenChange(ids: (string | number)[]): void {
    this.referenceOpen = ids;
    this.cdr.markForCheck();
  }

  onHeaderSearch(q: string): void {
    this.lastHeaderQuery = q;
    this.cdr.markForCheck();
  }

  get activeLabel(): string {
    return (
      NAV_GROUPS.flatMap((g) => g.items).find((i) => i.id === this.activeId)?.label ?? 'Dashboard'
    );
  }
...
<pui-lib-app-shell
  ...
  setMode(m: 'with-icons' | 'no-icons'): void {
    this.iconMode = m;
    this.cdr.markForCheck();
  }
...
export class AppComponent {
  ...
  api: ApiRow[] = [
    {
      input: 'sidebarGroups',
      type: 'SolifiNavGroup[]|SolifiNavItem[]',
      default: '[]',
      description:
        'Nav groups OR a flat array of items — pass SolifiNavGroup[] (navGroups) for a label above each cluster, or skip the wrapper and pass SolifiNavItem[] (navItems) directly for one ungrouped list (auto-detected, no label rendered). See "Grouped vs flat navigation" below. Items support iconName, icon (SVG), or text-only.',
    },
    {
    ...
    {
      input: 'sidebarBrandName',
      type: 'string',
      default: "'solifi'",
      description: 'Brand name shown next to the sidebar logo in expanded state.',
    },
    {
      input: 'sidebarLogoUrl',
      type: 'string',
      default: "''",
      description: 'Image URL for the sidebar logo (e.g. assets/logo.png).',
    },
    {
      input: 'showSidebarBrand',
      type: 'boolean | string',
      default: 'true',
      description:
        "Show/hide the sidebar's own logo section (expanded and collapsed states). Independent of showHeader.",
    },
    {
      input: 'sidebarCollapsed',
      type: 'boolean | string',
      default: 'false',
      description: 'Collapse the sidebar to a 64px icon-only rail.',
    },
    {
      input: 'showSidebar',
      type: 'boolean | string',
      default: 'true',
      description:
        'Master switch for the whole sidebar — hide it entirely, e.g. for a mobile flat layout.',
    },
    {
      input: 'sidebarWidth',
      type: 'number',
      default: '220',
      description: 'Sidebar expanded width in px.',
    },
    {
      input: 'sidebarCollapsedWidth',
      type: 'number',
      default: '64',
      description: 'Sidebar collapsed rail width in px.',
    },
    {
      input: 'sidebarTheme',
      type: 'SolifiSidebarTheme',
      default: 'SOLIFI_THEME',
      description: 'Full sidebar colour-token object. Use the SOLIFI_THEME preset.',
    },
    {
      input: 'showSidebarUser',
      type: 'boolean | string',
      default: 'false',
      description: 'Show the user-profile section at the bottom of the sidebar.',
    },
    {
      input: 'sidebarUserName',
      type: 'string',
      default: "''",
      description: 'Full name in the sidebar user-profile footer.',
    },
    {
      input: 'sidebarUserEmail',
      type: 'string',
      default: "''",
      description: 'Email shown under the name in the sidebar user-profile footer.',
    },
    {
      input: 'sidebarUserInitials',
      type: 'string',
      default: "''",
      description: 'Sidebar avatar initials — auto-derived from sidebarUserName if empty.',
    },
    {
      input: 'sidebarUserAvatarUrl',
      type: 'string',
      default: "''",
      description: 'Sidebar avatar photo URL. Falls back to the initials bubble.',
    },
    {
      input: 'sidebarUserMenuItems',
      type: 'SolifiUserMenuItem[]',
      default: '[]',
      description:
        'Sidebar profile popup menu items. Shown when the sidebar user-profile strip is clicked.',
    },
    {
      input: 'sidebarItemSelect',
      type: 'EventEmitter<SolifiNavItem>',
      default: '—',
      description: 'Fires on sidebar nav item click.',
    },
    {
      input: 'sidebarCollapsedChange',
      type: 'EventEmitter<boolean>',
      default: '—',
      description: "Fires when the sidebar's collapsed state toggles.",
    },
    {
      input: 'sidebarUserMenuSelect',
      type: 'EventEmitter<SolifiUserMenuItem>',
      default: '—',
      description: 'Fires when a sidebar user-profile menu item is selected.',
    },

    {
      ...
      default: 'true',
      description:
        'Master switch for the whole header. Set false for a flat layout — sidebar + content only, no header.',
    },
    { input: 'headerAppTitle', type: 'string', default: "''", description: 'Header title text.' },
    {
      ...
      type: 'string',
      default: "''",
      description: 'Header subtitle text, shown after a "|" separator.',
    },
    {
      input: 'headerLogoUrl',
      type: 'string',
      default: "''",
      description:
        'Header logo image URL — rendered in its own white panel, independent of the sidebar logo.',
    },
    {
      input: 'headerLogoText',
      type: 'string',
      default: "''",
      description: 'Text label shown next to the header logo image, if not baked into the image.',
    },
    {
      input: 'headerBgColor',
      type: 'string',
      default: "'var(--pui-header-bg)'",
      description:
        'Header background colour — defaults to the theme token (teal old theme, tan new theme).',
    },
    {
      input: 'headerTextColor',
      type: 'string',
      default: "'var(--pui-header-text)'",
      description: 'Header text colour.',
    },
    {
      input: 'showHeaderLogo',
      type: 'boolean | string',
      default: 'true',
      description: 'Show/hide the header logo section.',
    },
    {
      input: 'showHeaderHeading',
      type: 'boolean | string',
      default: 'true',
      description: 'Show/hide the header title/subtitle section.',
    },
    {
      input: 'showHeaderSearch',
      type: 'boolean | string',
      default: 'true',
      description:
        'Show/hide the header search button — expands inline in the header when clicked.',
    },
    {
      input: 'showHeaderUser',
      type: 'boolean | string',
      default: 'true',
      description:
        "Show/hide the header avatar area (independent of the sidebar's own showSidebarUser).",
    },
    {
      input: 'headerAvatarMode',
      type: `'menu'|'plain'`,
      default: "'menu'",
      description: 'Header avatar style — menu = name/email + dropdown, plain = round chip only.',
    },
    {
      input: 'headerUserName',
      type: 'string',
      default: "''",
      description: 'Name shown in the header avatar area — separate from sidebarUserName.',
    },
    {
      ...
      default: "''",
      description:
        'Email shown in the header avatar dropdown (menu mode only) — separate from sidebarUserEmail.',
    },
    {
      input: 'headerAvatarUrl',
      type: 'string',
      default: "''",
      description: 'Header avatar photo URL — falls back to initials.',
    },
    {
      input: 'headerAvatarColor',
      type: 'string',
      default: "'var(--pui-form-accent)'",
      description: 'Header avatar chip background colour.',
    },
    {
      input: 'headerAvatarTextColor',
      type: 'string',
      default: "'var(--pui-accent-ink)'",
      description: 'Header avatar initials text colour.',
    },
    {
      input: 'headerMenuItems',
      type: 'UserMenuItem[] | string',
      default: '[]',
      description:
        'Header avatar dropdown items (menu mode only) — shape {label, action, icon?, danger?}, not interchangeable with sidebarUserMenuItems.',
    },
    {
      input: 'headerBadge',
      type: 'HeaderBadge | string',
      default: 'null',
      description: 'Environment badge shown in the header (e.g. UAT/PROD).',
    },
    {
      input: 'headerSearchQuery',
      type: 'EventEmitter<string>',
      default: '—',
      description: "Fires as the user types in the header's inline search field.",
    },
    {
      input: 'headerMenuAction',
      type: 'EventEmitter<string>',
      default: '—',
      description: 'Fires when a header avatar dropdown item is clicked.',
    },

    {
      ...
      default: 'false',
      description:
        'Renders the full pui-lib-footer component instead of the plain footerText bar. Only one footer ever renders at once.',
    },
    {
      input: 'footerVariant',
      ...
      default: "'simple'",
      description:
        'Footer layout — contact (office-hours/address + CTA), disclaimer (body text + read-more link), or simple (copyright/links bar only).',
    },
    {
      input: 'footerNoticeSlides',
      type: 'FooterNoticeSlide[] | string',
      default: '[]',
      description:
        'Rotating notice-card slides shown above the copyright bar (contact/disclaimer variants).',
    },
    {
      input: 'footerActiveSlideIndex',
      type: 'number | string',
      default: '0',
      description: 'Index of the currently visible notice slide.',
    },
    {
      input: 'footerCopyrightText',
      type: 'string',
      default: "'Copyright © {year} Solifi...'",
      description: 'Copyright line in the rich footer — separate from the shell-level footerText.',
    },
    {
      input: 'footerLinks',
      type: 'FooterLink[] | string',
      default: '[]',
      description: 'Bottom-row links (label + href or action).',
    },
    {
      input: 'footerPoweredByText',
      type: 'string',
      default: "'Powered by Solifi™'",
      description: '"Powered by" label next to the copyright line.',
    },
    {
      input: 'showFooterPoweredBy',
      type: 'boolean | string',
      default: 'true',
      description: 'Show/hide the "powered by" label.',
    },
    {
      input: 'footerStickyBottom',
      type: 'boolean | string',
      default: 'false',
      description:
        'Pins the footer to the bottom of the viewport instead of flowing after page content.',
    },
    {
      input: 'footerActiveSlideIndexChange',
      type: 'EventEmitter<number>',
      default: '—',
      description: 'Fires when the active notice slide changes.',
    },
    {
      input: 'footerLinkClick',
      type: 'EventEmitter<FooterLink>',
      default: '—',
      description: 'Fires when a bottom-row footer link is clicked.',
    },
    {
      input: 'footerContactClick',
      type: 'EventEmitter<FooterNoticeSlide>',
      default: '—',
      description: "Fires when the contact variant's CTA button is clicked.",
    },

    {
      ...
      type: 'string',
      default: "''",
      description: 'Title shown in the bar under the header.',
    },
    {
      input: 'footerText',
      type: 'string',
      default: "''",
      description:
        'Plain one-line copyright bar. Ignored while showFooter is true (the rich footer replaces it).',
    },
  ];
}
