...
<script>
  ...
  overlayDemos = [
    {
      type: 'dash' as SpinnerType,
      color: '#12C6A8',
      bg: 'var(--pui-overlay-black-45)',
      opacity: 1,
      label: 'dash · default (matches modal backdrop)',
    },
    {
      ...
      bg: 'var(--pui-overlay-black-45)',
      opacity: 1,
      label: 'dots · default (matches modal backdrop)',
    },
  ];
  ...
  xfwRows = [
    ...
    {
      name: 'overlayColor',
      angular: 'overlayColor="#fff"',
      attr: 'overlay-color="#fff"',
      js: 'el.overlayColor = "#fff"',
    },
    {
      name: 'overlayOpacity',
      angular: '[overlayOpacity]="0.75"',
      attr: 'overlay-opacity="0.75"',
      js: 'el.overlayOpacity = 0.75',
    },
    {
      name: 'label',
      angular: 'label="Loading…"',
      attr: 'label="Loading…"',
      js: 'el.label = "Loading…"',
    },
  ];
  ...
  api: ApiRow[] = [
    {
      ...
      type: `'dash'|'dots'`,
      default: `'dash'`,
      description: 'dash = radiating lines Â· dots = orbiting dot ring.',
    },
    {
      input: 'size',
      type: `'sm'|'md'|'lg'|'xl'`,
      default: `'md'`,
      description: 'Size preset — sm 24px Â· md 40px Â· lg 56px Â· xl 80px.',
    },
    {
      input: 'sizePx',
      type: 'number',
      default: 'null',
      description: 'Exact pixel size — overrides the size preset.',
    },
    {
      input: 'color',
      type: 'string',
      default: `'var(--pui-form-accent, var(--pui-brand))'`,
      description:
        'Spinner colour (any CSS colour value) — defaults to the theme brand accent, so it follows the New/Old theme toggle.',
    },
    {
      input: 'speed',
      type: 'number',
    ...
    },
    {
      ...
      type: 'boolean',
      default: 'false',
      description: 'Render a fixed full-screen backdrop.',
    },
    {
      input: 'overlayColor',
      type: 'string',
      default: `'var(--pui-overlay-black-45)'`,
      description:
        'Overlay background colour — defaults to the same scrim token pui-lib-modal / pui-lib-form-dialog use, so it matches their backdrop.',
    },
    {
      input: 'overlayOpacity',
      type: 'number',
      default: '1',
      description: 'Overlay opacity — 0 (clear) to 1 (solid).',
    },
    {
      input: 'zIndex',
      type: 'number',
      default: '1000',
      description: 'z-index of overlay; spinner renders at zIndex + 1.',
    },
    {
      input: 'label',
      type: 'string',
      default: `''`,
      description: 'Optional text displayed below the spinner.',
    },
    {
      input: 'labelColor',
      type: 'string',
