...
customElements.whenDefined('pui-lib-list').then(() => {
  ...
  notifItems: ListItem[] = [
    ...
    },
    {
      ...
      description: 'v1.4.0 was deployed to production successfully.',
      badge: 'Done',
      meta: '1h ago',
    },
    {
      id: 3,
      label: 'Build failed',
      description: 'The staging pipeline failed on step “test”.',
      badge: 'Fail',
      meta: '3h ago',
    },
    {
      ...
      description: 'Dependabot found 2 high-severity vulnerabilities.',
      badge: '!',
      meta: '5h ago',
    },
    {
      ...
      description: 'Downtime window: Saturday 02:00–04:00 UTC.',
      meta: 'Tomorrow',
    },
  ];
  ...
  orderItems: ListItem[] = [
    {
      id: 'ord-1',
      label: 'Order #1024 — MacBook Pro 16”',
      description: 'Placed by Alice Johnson · 3 items',
      badge: 'Shipped',
      meta: 'Aug 10',
    },
    {
      id: 'ord-2',
      label: 'Order #1025 — iPhone 15 Pro',
      description: 'Placed by Bob Smith · 1 item',
      badge: 'Processing',
      meta: 'Aug 12',
    },
    {
      id: 'ord-3',
      label: 'Order #1026 — AirPods Pro',
      description: 'Placed by Carol Williams · 2 items',
      badge: 'Delivered',
      meta: 'Aug 8',
    },
    {
      id: 'ord-4',
      label: 'Order #1027 — iPad Air',
      description: 'Placed by David Brown · 1 item',
      badge: 'Cancelled',
      meta: 'Aug 7',
    },
    {
      id: 'ord-5',
      label: 'Order #1028 — Apple Watch S9',
      description: 'Placed by Eva Martinez · 1 item',
      badge: 'Shipped',
      meta: 'Aug 13',
    },
    {
      id: 'ord-6',
      label: 'Order #1029 — Mac Mini M3',
      description: 'Placed by Frank Lee · 1 item',
      badge: 'Pending',
      meta: 'Aug 14',
    },
  ];
  ...
  xfwRows = [
    ...
    {
      name: 'variant',
      angular: 'variant=”flush”',
      attr: 'variant=”flush”',
      js: 'el.variant = “flush”',
    },
    {
      name: 'selectable',
      angular: '[selectable]=”true”',
      attr: 'selectable',
    ...
    {
      name: 'textColor',
      angular: 'textColor=”#1e293b”',
      attr: 'textColor=”#…”',
      js: 'el.textColor = “#1e293b”',
    },
    {
      name: 'activeColor',
      angular: 'activeColor=”#0d9488”',
      attr: 'activeColor=”#…”',
      js: 'el.activeColor = “#0d9488”',
    },
    {
      name: 'hoverColor',
      angular: 'hoverColor=”#f0fdfa”',
      attr: 'hoverColor=”#…”',
      js: 'el.hoverColor = “#f0fdfa”',
    },
    {
      name: 'itemSelect',
  ...
  api: ApiRow[] = [
    {
      ...
      default: '[]',
      description:
        'Array of list items. Each has id, label, and optional description, icon, badge, meta, disabled, divider.',
    },
    {
      input: 'variant',
      type: `'bordered'|'striped'|'flush'|'default'`,
      default: `'bordered'`,
      description: 'Visual layout of the list.',
    },
    {
      input: 'selectable',
      type: 'boolean',
      default: 'false',
      description: 'Enables clickable rows with a selection highlight.',
    },
    {
      input: 'selectedId',
    ...
    },
    {
      ...
      default: '””',
      description:
        'CSS color for all item labels. Empty string inherits the default neutral text color.',
    },
    {
      input: 'activeColor',
      type: 'string',
      default: '”#0d9488”',
      description:
        'CSS color applied to the selected row text. A tinted version (12% opacity) is used as the background.',
    },
    {
      input: 'hoverColor',
      type: 'string',
      default: '”#f0fdfa”',
      description: 'CSS background color shown on row hover (non-selected rows only).',
    },
    {
      input: 'itemSelect',
      type: 'EventEmitter<ListItem>',
      default: '—',
      description: 'Emits the clicked ListItem when selectable is true.',
    },
  ];
