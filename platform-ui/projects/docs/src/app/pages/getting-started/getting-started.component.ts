    ...
    <div class="gs-wrap">
      <article class="gs-content">
        ...
        <p class="gs-lead">
          ...
          <strong>Angular</strong>, <strong>React</strong>, and <strong>plain HTML</strong> — pick
          your framework below and follow the steps.
        </p>

        <!-- Framework picker tabs -->
        <div class="fw-tabs">
          <button
            *ngFor="let fw of frameworks; trackBy: trackByIndex"
            class="fw-tab"
        ...
        <ng-container *ngIf="active === 'angular'">
          ...
          <div class="mode-toggle">
            <button
              class="mode-btn"
              [class.mode-btn--active]="ngMode === 'published'"
              (click)="ngMode = 'published'"
            >
              Published npm (production)
            </button>
            <button
              class="mode-btn"
              [class.mode-btn--active]="ngMode === 'local'"
              (click)="ngMode = 'local'"
            >
          ...
          <ng-container *ngIf="ngMode === 'published'">
            <section id="ng-prereq" class="gs-section">
              ...
              <div class="hiw-header">
                ...
                <span class="hiw-sub"
                  >Platform UI ships as <strong>Angular 19 standalone components</strong>. NgModule
                  apps work too — just add them to your <code>imports</code> array.</span
                >
              </div>
              <div class="hiw-grid">
                <div class="hiw-card">
                  <div class="hiw-card__title">Standalone import</div>
                  <div class="hiw-card__desc">
                    Add the component directly to your standalone component's <code>imports</code>
                  </div>
                ...
                <div class="hiw-card">
                  ...
                  <div class="hiw-card__desc">
                    Import in your <code>&#64;NgModule</code> — all its components become available
                    in templates
                  </div>
                  <code class="hiw-card__code">imports: [PuiButtonComponent]</code>
                </div>
                <div class="hiw-card">
                  ...
                  <div class="hiw-card__desc">
                    Use standard Angular <code>[input]</code> and <code>(event)</code> bindings
                  </div>
            ...
            <section id="ng-npmrc" class="gs-section">
              <h2 class="gs-h2">
                <span class="step-badge">2</span> Configure npm for GitHub Packages
              </h2>
              <p class="gs-p">
                Create <code>.npmrc</code> in your project root and paste the two lines below.
                Replace <code>YOUR_GITHUB_PAT_HERE</code> with your token:
              </p>
              <docs-code-block
                lang=".npmrc"
                [id]="'ng-npmrc'"
                [text]="code.ng.npmrc"
                [copied]="copied"
                (copyClick)="doCopy($event.text, $event.id)"
              ></docs-code-block>
              <div class="note note--warn">
                Add <code>.npmrc</code> to <code>.gitignore</code> — never commit a token to source
                control.
              </div>
            </section>
            ...
            <section id="ng-install" class="gs-section">
              ...
              <p class="gs-p">
                Add the package to the <code>skip</code> list so Native Federation does not try to
                re-bundle it:
              </p>
              <docs-code-block
                lang="federation.config.js"
                [id]="'ng-fed'"
                [text]="code.ng.federation"
                [copied]="copied"
                (copyClick)="doCopy($event.text, $event.id)"
              ></docs-code-block>
            </section>
            ...
            <section id="ng-styles" class="gs-section">
              ...
              <p class="gs-p">
                Open <code>angular.json</code> and add <strong>two</strong> library CSS files to the
                <code>"styles"</code> array. The tokens file defines all CSS custom properties; the
                theme file applies the default teal colour scheme. Consumers import them explicitly
                — they are never bundled automatically:
              </p>
              <docs-code-block
                lang="angular.json"
                [id]="'ng-styles'"
              ...
              ></docs-code-block>
              <div class="note note--warn">
                Do <strong>not</strong> import from <code>elements/styles.css</code> — that path is
                for the Angular Elements / web-component build only. Angular consumers always import
                from <code>styles/tokens.css</code> and <code>styles/themes/theme-new.css</code>.
              </div>
              <div class="note note--warn">
                <strong>A common mistake:</strong> <code>angular.json</code> has a <em>separate</em>
                <code>"styles"</code> array for every architect target — <code>build</code>,
                <code>test</code>, etc. Adding these two files to
                <code>architect &gt; test &gt; options &gt; styles</code> does nothing for your
                running app — that array is only read by <code>ng test</code>. They must go in
                <code>architect &gt; build &gt; options &gt; styles</code>, the one used by
                <code>ng serve</code> and <code>ng build</code>. If your components render with no
                colours, no fonts, and no layout, this is almost always why — double-check you
                edited the right block.
              </div>
            </section>
            ...
            <section id="ng-use" class="gs-section">
              ...
              <p class="gs-p">
                Drop <code>pui-lib-app-shell</code> into your root component. Wire
                <code>provideRouter(routes)</code> in <code>app.config.ts</code> and place
                <code>&lt;router-outlet /&gt;</code> inside the shell tag — the sidebar navigation
                drives Angular's router automatically via the
                <code>(sidebarItemSelect)</code> output:
              </p>
              <docs-code-block
                lang="app.config.ts"
                [id]="'ng-config'"
                [text]="code.ng.appConfig"
                [copied]="copied"
                (copyClick)="doCopy($event.text, $event.id)"
              ></docs-code-block>
              <docs-code-block
              ...
              ></docs-code-block>
              <docs-code-block
                lang="app.component.html"
                [id]="'ng-shell-html'"
                [text]="code.ng.shellHtml"
                [copied]="copied"
                (copyClick)="doCopy($event.text, $event.id)"
                style="margin-top:14px"
              ></docs-code-block>
            ...
            <section id="ng-verify" class="gs-section">
              ...
              <div class="note note--success" style="margin-top:18px">
                Open <strong>http://localhost:4200</strong>. You should see the teal header, sidebar
                rail, and hamburger toggle.
              </div>
          ...
          <ng-container *ngIf="ngMode === 'local'">
            <div class="note note--info" style="margin-bottom:28px">
              Use this when you are actively developing the library and want a consumer app to pick
              up changes instantly — <strong>no publish step required</strong>. The mechanism is
              <code>npm link</code> + a symlink from the consumer's <code>node_modules</code> to the
              library's local <code>dist/</code> folder.
            </div>
            ...
            <section id="ng-local-build" class="gs-section">
              ...
              <p class="gs-p">
                Run this inside the <strong>library repo</strong>. This produces the compiled output
                in <code>dist/platform-ui/</code>:
              </p>
              <docs-code-block
                lang="bash"
                [id]="'ng-local-build'"
                [text]="code.ng.localBuild"
                [copied]="copied"
                (copyClick)="doCopy($event.text, $event.id)"
              ></docs-code-block>
              <div class="note note--info">
                Using <code>--configuration development</code> skips the lint step so the build is
                faster. Never use <code>npm run build:local</code> — it runs lint first and may
                block.
              </div>
            </section>
            ...
            <section id="ng-local-link1" class="gs-section">
              <h2 class="gs-h2">
                <span class="step-badge">3</span> Register the dist Folder Globally
              </h2>
              <p class="gs-p">
                Navigate into the <strong>built output folder</strong> and run
                <code>npm link</code>. This registers
                <code>&#64;bhairab-patra/platform-ui</code> globally on your machine:
              </p>
              <docs-code-block
                lang="bash"
                [id]="'ng-local-link1'"
                [text]="code.ng.localLink1"
                [copied]="copied"
                (copyClick)="doCopy($event.text, $event.id)"
              ></docs-code-block>
              <p class="gs-p" style="margin-top:10px">
                Do this <strong>once per machine</strong> (or after a fresh clone). You do not need
                to repeat it every rebuild.
              </p>
            </section>
            ...
            <section id="ng-local-link2" class="gs-section">
              ...
              <p class="gs-p">
                Inside your <strong>Angular consumer app</strong>, link it to the globally
                registered dist:
              </p>
              <docs-code-block
                lang="bash"
                [id]="'ng-local-link2'"
                [text]="code.ng.localLink2"
                [copied]="copied"
                (copyClick)="doCopy($event.text, $event.id)"
              ></docs-code-block>
              <div class="note note--warn">
                If you run <code>npm install</code> in the consumer later, it will overwrite this
                symlink. Just run the link command again to restore it.
              </div>
            </section>

            <section id="ng-local-syms" class="gs-section">
              <h2 class="gs-h2">
                <span class="step-badge">5</span> Add preserveSymlinks to angular.json
              </h2>
              <p class="gs-p">
                Without this, Angular loads two separate copies of <code>&#64;angular/core</code> —
                one from the library's own <code>node_modules</code> and one from the consumer's.
                This causes <code>lView</code> errors and injection failures at runtime. Open
                <code>angular.json</code> and add one line:
              </p>
              <docs-code-block
                lang="angular.json"
                [id]="'ng-local-syms'"
                [text]="code.ng.preserveSymlinks"
                [copied]="copied"
                (copyClick)="doCopy($event.text, $event.id)"
              ></docs-code-block>
            </section>
            ...
            <section id="ng-local-styles" class="gs-section">
              ...
              <p class="gs-p">
                Add the two library CSS files to the <code>"styles"</code> array in
                <code>angular.json</code>. After linking, the symlink makes these resolve to your
                local <code>dist/platform-ui/styles/</code>:
              </p>
              <docs-code-block
                lang="angular.json"
                [id]="'ng-local-styles'"
                [text]="code.ng.stylesLocal"
                [copied]="copied"
                (copyClick)="doCopy($event.text, $event.id)"
              ></docs-code-block>
              <div class="note note--warn">
                <strong>A common mistake:</strong> <code>angular.json</code> has a <em>separate</em>
                <code>"styles"</code> array per architect target. These files must go in
                <code>architect &gt; build &gt; options &gt; styles</code> — the one
                <code>ng serve</code> reads. Adding them only under
                <code>architect &gt; test &gt; options</code> has no effect on your running app and
                is the #1 cause of "components render with no styling at all."
              </div>
            </section>
            ...
            <section id="ng-local-import" class="gs-section">
              ...
              <p class="gs-p">
                Import exactly the same way as the published flow — the symlink makes npm think it
                is the real package:
              </p>
              <docs-code-block
                lang="TypeScript"
            ...
            <section id="ng-local-serve" class="gs-section">
              ...
              <docs-code-block
                lang="bash"
                [id]="'ng-local-serve'"
                [text]="code.ng.localServe"
                [copied]="copied"
                (copyClick)="doCopy($event.text, $event.id)"
              ></docs-code-block>
              <div class="note note--success" style="margin-top:18px">
                Open <strong>http://localhost:4200</strong>. Every time you rebuild the library,
                refresh the browser — no re-link needed.
              </div>
            </section>
            ...
            <section id="ng-local-daily" class="gs-section">
              ...
              <docs-code-block
                lang="bash"
                [id]="'ng-local-daily'"
                [text]="code.ng.localDaily"
                [copied]="copied"
                (copyClick)="doCopy($event.text, $event.id)"
              ></docs-code-block>
              <h3 class="gs-h3" style="margin-top:20px">
                Or watch mode — rebuilds automatically on every save:
              </h3>
              <docs-code-block
                lang="bash"
                [id]="'ng-local-watch'"
                [text]="code.ng.localWatch"
                [copied]="copied"
                (copyClick)="doCopy($event.text, $event.id)"
              ></docs-code-block>
            </section>
              ...
              <div class="blocker-list">
                <div class="blocker-item">
                  <div class="blocker-title">
                    ❌ &nbsp;<code>lView[15] null</code> or injection errors at startup
                  </div>
                  <div class="blocker-body">
                    <strong>Cause:</strong> Angular loaded two copies of
                    <code>&#64;angular/core</code> through the symlink.<br />
                    <strong>Fix:</strong> Make sure <code>"preserveSymlinks": true</code> is in
                    <code>angular.json</code> (Step 5). Then clear the cache:
                    <docs-code-block
                      lang="bash"
                      [id]="'ng-fix-lview'"
                      [text]="code.ng.clearCache"
                      [copied]="copied"
                      (copyClick)="doCopy($event.text, $event.id)"
                ...
                <div class="blocker-item">
                  <div class="blocker-title">
                    ❌ &nbsp;Stale output — old component version still shows after rebuild
                  </div>
                  <div class="blocker-body">
                    <strong>Cause:</strong> Angular compiler cache is holding the old build.<br />
                    <strong>Fix:</strong> Delete the cache and restart. Use <code>rm -rf</code> in
                    Git Bash — <code>rmdir /s /q</code> does not work in Git Bash.
                    <docs-code-block
                      lang="bash (Git Bash)"
                      [id]="'ng-fix-cache'"
                      [text]="code.ng.clearCache"
                ...
                <div class="blocker-item">
                  <div class="blocker-title">
                    ❌ &nbsp;Cannot find module <code>&#64;bhairab-patra/platform-ui</code>
                  </div>
                  <div class="blocker-body">
                    <strong>Cause:</strong> <code>npm install</code> ran after
                    <code>npm link</code> and overwrote the symlink.<br />
                ...
                <div class="blocker-item">
                  <div class="blocker-title">
                    ❌ &nbsp;Build fails — lint errors block the build
                  </div>
                  <div class="blocker-body">
                    <strong>Cause:</strong> <code>npm run build:local</code> runs lint before
                    compiling.<br />
        ...
        <ng-container *ngIf="active === 'react'">
          ...
          <div class="mode-toggle">
            <button
              class="mode-btn"
              [class.mode-btn--active]="rxMode === 'published'"
              (click)="rxMode = 'published'"
            >
              📦 Published npm (production)
            </button>
            <button
              class="mode-btn"
              [class.mode-btn--active]="rxMode === 'local'"
              (click)="rxMode = 'local'"
            >
              🔧 Local Dev (without publishing)
            </button>
          ...
          <ng-container *ngIf="rxMode === 'published'">
            <section id="rx-prereq" class="gs-section">
              ...
              <div class="hiw-header">
                <span class="hiw-label">How it works</span>
                <span class="hiw-sub"
                  >Platform UI exposes components as <strong>Angular Elements</strong> (Web
                  Components). React 19 supports custom elements natively — no wrapper needed.</span
                >
              </div>
              <div class="hiw-grid">
                <div class="hiw-card">
                ...
                <div class="hiw-card">
                  ...
                  <div class="hiw-card__desc">
                    Stringify and pass as attribute — Angular parses via
                ...
                <div class="hiw-card">
                  ...
                  <div class="hiw-card__desc">
                    Native CustomEvents — listen via <code>addEventListener</code> on a ref
                  </div>
            ...
            <section id="rx-create" class="gs-section">
              <h2 class="gs-h2">
                <span class="step-badge">2</span> Create a React + Vite App (skip if existing)
              </h2>
              <docs-code-block
                lang="bash"
                [id]="'rx-create'"
                [text]="code.react.create"
                [copied]="copied"
                (copyClick)="doCopy($event.text, $event.id)"
              ></docs-code-block>
            </section>
            ...
            <section id="rx-npmrc" class="gs-section">
              <h2 class="gs-h2">
                <span class="step-badge">3</span> Configure npm for GitHub Packages
              </h2>
              <p class="gs-p">
                Create <code>.npmrc</code> in your project root and replace the token:
              </p>
              <docs-code-block
                lang=".npmrc"
                [id]="'rx-npmrc'"
                [text]="code.react.npmrc"
                [copied]="copied"
                (copyClick)="doCopy($event.text, $event.id)"
              ></docs-code-block>
              <div class="note note--warn">
                Add <code>.npmrc</code> to <code>.gitignore</code> — never commit a token.
              </div>
            </section>
            ...
            <section id="rx-install" class="gs-section">
              ...
              <docs-code-block
                lang="bash"
                [id]="'rx-install'"
                [text]="code.react.install"
                [copied]="copied"
                (copyClick)="doCopy($event.text, $event.id)"
              ></docs-code-block>
              <p class="gs-p" style="margin-top:12px">
                After install, the files used by React live inside the package:
              </p>
              <div class="file-list">
                <div class="file-row">
                  ...
                  <div>
                    <div class="file-name">
                      node_modules/&#64;bhairab-patra/platform-ui/elements/pui-elements.js
                    </div>
                    <div class="file-desc">
                      All components as Web Components — Angular runtime bundled inside
                    </div>
                  </div>
                </div>
                <div class="file-row">
                  ...
                  <div>
                    <div class="file-name">
                      node_modules/&#64;bhairab-patra/platform-ui/elements/runtime.js
                    </div>
                    <div class="file-desc">
                      Angular Webpack runtime — must load before pui-elements.js
                    </div>
                  </div>
                </div>
                <div class="file-row">
                  ...
                  <div>
                    <div class="file-name">
                      node_modules/&#64;bhairab-patra/platform-ui/elements/polyfills.js
                    </div>
                    <div class="file-desc">
                      Zone.js polyfills — must load before pui-elements.js
                    </div>
                  </div>
                </div>
                <div class="file-row">
                  ...
                  <div>
                    ...
                    <div class="file-desc">
                      CSS custom properties (design tokens) — load in &lt;head&gt;
                    </div>
                  </div>
                </div>
                <div class="file-row">
            ...
            <section id="rx-bootstrap" class="gs-section">
              <h2 class="gs-h2">
                <span class="step-badge">5</span> Load the Elements Bundle in index.html
              </h2>
              <p class="gs-p">
                The Angular Elements bundle is <strong>not an ES module</strong> — it must be loaded
                as plain <code>&lt;script&gt;</code> tags in <code>index.html</code>,
                <strong>in this exact order</strong>. The styles must also be loaded via
                <code>&lt;link&gt;</code> tags:
              </p>
              <docs-code-block
                lang="index.html"
                [id]="'rx-main'"
                [text]="code.react.main"
                [copied]="copied"
                (copyClick)="doCopy($event.text, $event.id)"
              ></docs-code-block>
              <div class="note note--warn" style="margin-top:14px">
                <strong>Order matters:</strong> runtime.js → polyfills.js → pui-elements.js. Loading
                out of order causes Angular bootstrap to fail silently.
              </div>
            </section>
            ...
            <section id="rx-types" class="gs-section">
              ...
              <p class="gs-p">
                Create <code>src/pui.d.ts</code> so TypeScript recognises all
                <code>pui-*</code> tags in JSX without errors:
              </p>
              <docs-code-block
                lang="src/pui.d.ts"
                [id]="'rx-types'"
                [text]="code.react.types"
                [copied]="copied"
                (copyClick)="doCopy($event.text, $event.id)"
              ></docs-code-block>
              <p class="gs-p" style="margin-top:14px">
                Then reference it in <code>tsconfig.json</code>:
              </p>
              <docs-code-block
                lang="tsconfig.json"
                [id]="'rx-tsref'"
                [text]="code.react.tsconfig"
                [copied]="copied"
                (copyClick)="doCopy($event.text, $event.id)"
              ></docs-code-block>
            </section>
            ...
            <section id="rx-use" class="gs-section">
              ...
              <p class="gs-p">
                <strong>String inputs</strong> → kebab-case HTML attributes (<code
                  >app-title="My App"</code
                >).<br />
                <strong>Array / Object inputs</strong> → pass as
                <code>JSON.stringify()</code> string attributes. Angular Elements parses them via
                <code>attributeChangedCallback</code> which is zone-patched and automatically
            ...
            <section id="rx-events" class="gs-section">
              ...
              <p class="gs-p">
                All outputs are native <code>CustomEvent</code>s — use
                <code>addEventListener</code> via a <code>ref</code> in a <code>useEffect</code>:
              </p>
              <docs-code-block
                lang="src/App.tsx"
                [id]="'rx-events'"
                [text]="code.react.events"
                [copied]="copied"
                (copyClick)="doCopy($event.text, $event.id)"
              ></docs-code-block>
            </section>
            ...
            <section id="rx-verify" class="gs-section">
              ...
              ></docs-code-block>
              <div class="note note--success" style="margin-top:18px">
                Open <strong>http://localhost:5173</strong>. You should see the full Platform UI
                shell — header, sidebar, and your React content — rendered inside the browser.
              </div>
            </section> </ng-container
          ><!-- end published -->
          ...
          <ng-container *ngIf="rxMode === 'local'">
            <div class="note note--info" style="margin-bottom:28px">
              Use this when you are actively developing the library and want the React app to pick
              up changes instantly —
              <strong>no publish step required, no npm link needed</strong>.<br /><br />
              The mechanism: a <strong>Vite auto-copy plugin</strong> copies the built bundle files
              from <code>dist/elements/</code> into the React app's <code>public/</code> folder on
              every dev server start. Vite then serves them as static files.<br /><br />
              <strong>Important:</strong> Angular CLI outputs the main bundle as
              <code>main.js</code> — the plugin copies it to <code>public/pui-elements.js</code> so
              the script tag in <code>index.html</code> stays consistent.
            </div>
            ...
            <section id="rx-local-build" class="gs-section">
              ...
              <p class="gs-p">
                Run this inside the <strong>library repo</strong>. The elements build produces the
                web components bundle that the React app loads:
              </p>
              <docs-code-block
                lang="bash"
                [id]="'rx-local-build'"
                [text]="code.react.localBuild"
                [copied]="copied"
                (copyClick)="doCopy($event.text, $event.id)"
              ></docs-code-block>
              <div class="file-list" style="margin-top:14px">
                <div class="file-row">
                  ...
                  <div>
                    ...
                    <div class="file-desc">
                      Web components bundle (Angular CLI names it main.js) — Vite copies it to
                      public/pui-elements.js
                    </div>
                  </div>
                </div>
                <div class="file-row">
                  ...
                  <div>
                    ...
                    <div class="file-desc">
                      Angular runtime chunks — also copied to public/ and loaded before
                      pui-elements.js
                    </div>
                  </div>
                </div>
                <div class="file-row">
                  ...
                  <div>
                    <div class="file-name">
                      dist/platform-ui/styles/tokens.css &amp; themes/theme-new.css
                    </div>
                    <div class="file-desc">
                      Design token CSS files — also copied to public/ and loaded as &lt;link&gt;
                      tags
                    </div>
                  </div>
                </div>
            ...
            <section id="rx-local-vite" class="gs-section">
              ...
              <p class="gs-p">
                Add a Vite plugin that copies the built bundle files into <code>public/</code> on
                every server start. Vite then serves them as static files at
                <code>/pui-*.js</code> and <code>/tokens.css</code>. The plugin also watches
                <code>dist/elements/</code> and triggers a full reload when you rebuild.
              </p>
              <docs-code-block
                lang="vite.config.js"
                [id]="'rx-local-vite'"
                [text]="code.react.localVite"
                [copied]="copied"
                (copyClick)="doCopy($event.text, $event.id)"
              ></docs-code-block>
            ...
            <section id="rx-local-html" class="gs-section">
              ...
              <p class="gs-p">
                Add the design token CSS files and
                <strong>three script tags in order</strong> inside <code>&lt;head&gt;</code>. All
                five files are served from <code>public/</code> by Vite:
              </p>
              <docs-code-block
                lang="index.html"
                [id]="'rx-local-html'"
                [text]="code.react.localHtml"
                [copied]="copied"
                (copyClick)="doCopy($event.text, $event.id)"
              ></docs-code-block>
              <div class="note note--warn" style="margin-top:14px">
                <strong>Script order is mandatory:</strong> pui-runtime.js → pui-polyfills.js →
                pui-elements.js. Do <strong>not</strong> add <code>type="module"</code> or
                <code>defer</code> to these — they must run synchronously before React's module
                script loads.
              </div>
            </section>
            ...
            <section id="rx-local-mainjs" class="gs-section">
              ...
              <p class="gs-p">
                Gate the React render with <code>customElements.whenDefined()</code>. This ensures
                all <code>pui-*</code> custom elements are registered before React renders any JSX
            ...
            <section id="rx-local-types" class="gs-section">
              ...
              <p class="gs-p">
                Create <code>src/pui.d.ts</code> so TypeScript recognises all <code>pui-*</code> JSX
                tags:
              </p>
              <docs-code-block
                lang="src/pui.d.ts"
            ...
            <section id="rx-local-use" class="gs-section">
              ...
              <p class="gs-p">
                ...
                Arrays/Objects → <code>JSON.stringify()</code> string attributes. Angular Elements'
                <code>attributeChangedCallback</code> is zone-patched and triggers change detection
                automatically — no manual <code>ref</code> property setting needed.
              </p>
              <docs-code-block
                lang="src/App.tsx"
                [id]="'rx-local-use'"
            ...
            <section id="rx-local-serve" class="gs-section">
              ...
              ></docs-code-block>
              <div class="note note--success" style="margin-top:18px">
                Open <strong>http://localhost:5173</strong>. On startup Vite copies the built bundle
                files to <code>public/</code> and serves them. You should see the full shell — teal
                header, dark sidebar with nav groups, and your React content.
              </div>
            </section>
            ...
            <section id="rx-local-daily" class="gs-section">
              ...
              <p class="gs-p">
                After changing any library source, rebuild the elements bundle then restart or
                refresh Vite (it re-copies on server start):
              </p>
              <docs-code-block
                lang="bash"
                [id]="'rx-local-daily'"
              ...
              ></docs-code-block>
              <div class="note note--info" style="margin-top:14px">
                The Vite plugin watches <code>dist/elements/</code> — if you rebuild the elements
                bundle while Vite is running, it detects the file change and triggers a
                <strong>full browser reload</strong> automatically.
              </div>
            </section>
            ...
            <section id="rx-local-blockers" class="gs-section">
              ...
              <div class="blocker-list">
                <div class="blocker-item">
                  ...
                  <div class="blocker-body">
                    <strong>Cause:</strong> The elements bundle has not been built yet, or the Vite
                    auto-copy plugin could not find <code>dist/elements/main.js</code>.<br />
                    <strong>Fix:</strong> Build the elements bundle, then restart Vite:
                    <docs-code-block
                      lang="bash"
                      [id]="'rx-fix-404'"
                      [text]="code.react.localElementsBuild"
                      [copied]="copied"
                      (copyClick)="doCopy($event.text, $event.id)"
                      style="margin-top:10px"
                    ></docs-code-block>
                ...
                <div class="blocker-item">
                  ...
                  <div class="blocker-body">
                    <strong>Cause:</strong> <code>pui-lib-header</code> and
                    <code>pui-lib-sidebar</code> are registered as standalone custom elements in the
                    elements bundle. When <code>pui-lib-app-shell</code> renders its template
                    containing <code>&lt;pui-lib-header&gt;</code>, the browser fires
                    <code>connectedCallback</code> again — bootstrapping a second Angular component
                    instance alongside the one Angular's template engine already manages.<br />
                    <strong>Fix:</strong> Do <strong>not</strong> register
                    <code>pui-lib-header</code> or <code>pui-lib-sidebar</code> as custom elements
                    in <code>main.ts</code>. They are internal to the app-shell and managed by
                    Angular's template engine. Only <code>pui-lib-app-shell</code> should be
                ...
                <div class="blocker-item">
                  ...
                  <div class="blocker-body">
                    <strong>Cause:</strong> Passing arrays/objects as JS DOM properties from React's
                    <code>useEffect</code> may not trigger Angular change detection if the property
                    setter runs outside Angular's zone.<br />
                    <strong>Fix:</strong> Pass arrays and objects as
                    <code>JSON.stringify()</code> string attributes directly in JSX. Angular
                    Elements' <code>attributeChangedCallback</code> is zone-patched and triggers
                    change detection automatically:
                    <docs-code-block
                      lang="JSX"
                      [id]="'rx-fix-prop'"
                      [text]="code.react.propFix"
                      [copied]="copied"
                      (copyClick)="doCopy($event.text, $event.id)"
                      style="margin-top:10px"
                    ></docs-code-block>
                ...
                <div class="blocker-item">
                  <div class="blocker-title">
                    ❌ &nbsp;Components not updating after library rebuild
                  </div>
                  <div class="blocker-body">
                    <strong>Cause:</strong> Only the library was rebuilt — the elements bundle still
                    has the old code.<br />
                    <strong>Fix:</strong> Rebuild the elements bundle. The Vite plugin auto-detects
                    the change in <code>dist/elements/</code> and triggers a full reload:
                    <docs-code-block
                      lang="bash"
                      [id]="'rx-fix-stale'"
                      [text]="code.react.localBuild"
        ...
        <ng-container *ngIf="active === 'html'">
          ...
          <div class="hiw-header" style="margin-top:4px">
            <span class="hiw-label">How it works</span>
            <span class="hiw-sub"
              >No build tool, no bundler, no framework — just a <code>&lt;script&gt;</code> tag.
              Angular Elements <strong>cannot run from <code>file://</code></strong> — use a local
              HTTP server.</span
            >
          </div>
          <div class="hiw-grid" style="margin-bottom:28px">
            <div class="hiw-card">
              <div class="hiw-card__title">String inputs</div>
              <div class="hiw-card__desc">
                Pass as kebab-case HTML attributes directly on the element tag
              </div>
              <code class="hiw-card__code">app-title="My App"</code>
            </div>
            <div class="hiw-card">
              <div class="hiw-card__title">Array / Object inputs</div>
              <div class="hiw-card__desc">
                Set via <code>element.setAttribute()</code> with a
            ...
            <div class="hiw-card">
              <div class="hiw-card__title">Events</div>
              <div class="hiw-card__desc">
                Native CustomEvents — listen with <code>addEventListener</code>
              </div>
          ...
          <section id="html-npmrc" class="gs-section">
            <h2 class="gs-h2">
              <span class="step-badge">1</span> Configure npm for GitHub Packages
            </h2>
            <p class="gs-p">Create <code>.npmrc</code> in your project folder:</p>
            <docs-code-block
              lang=".npmrc"
              [id]="'html-npmrc'"
              [text]="code.html.npmrc"
              [copied]="copied"
              (copyClick)="doCopy($event.text, $event.id)"
            ></docs-code-block>
          ...
          <section id="html-install" class="gs-section">
            ...
            <docs-code-block
              lang="bash"
              [id]="'html-install'"
              [text]="code.html.install"
              [copied]="copied"
              (copyClick)="doCopy($event.text, $event.id)"
            ></docs-code-block>
            <p class="gs-p" style="margin-top:12px">
              This creates <code>node_modules/&#64;bhairab-patra/platform-ui/elements/</code> with
              two files you need:
            </p>
            <div class="file-list">
              <div class="file-row">
          ...
          <section id="html-page" class="gs-section">
            ...
            <p class="gs-p">
              Reference the files from <code>node_modules</code> — they will be served by the HTTP
          ...
          <section id="html-serve" class="gs-section">
            ...
            <p class="gs-p">
              Run this command from the folder that contains your <code>index.html</code> and
              <code>node_modules/</code>:
            </p>
            <docs-code-block
              lang="bash"
              [id]="'html-serve'"
              [text]="code.html.serve"
              [copied]="copied"
              (copyClick)="doCopy($event.text, $event.id)"
            ></docs-code-block>
            <div class="note note--success" style="margin-top:18px">
              Open <strong>http://localhost:4300</strong> in your browser. The shell, sidebar, and
          ...
          <section id="html-events" class="gs-section">
            ...
            <div class="rules-list">
              <div class="rule-row">
                ...
                <div>
                  <strong>String inputs</strong> → HTML attributes in kebab-case:
                  <code>app-title="My App"</code>
                </div>
              </div>
              <div class="rule-row">
                <span class="rule-badge rule-badge--ok">✓</span>
                <div>
                  <strong>Object / Array inputs</strong> → set as JS property after element is
                  defined: <code>el.sidebarGroups = [...]</code>
                </div>
              </div>
              <div class="rule-row">
                <span class="rule-badge rule-badge--ok">✓</span>
                <div>
                  <strong>Events</strong> → native <code>addEventListener</code>:
                  <code>el.addEventListener('sidebarItemSelect', fn)</code>
                </div>
              </div>
              <div class="rule-row">
                <span class="rule-badge rule-badge--warn">✗</span>
                <div>
                  Do <strong>not</strong> open <code>index.html</code> directly in the browser —
              ...
              <div class="rule-row">
                <span class="rule-badge rule-badge--warn">✗</span>
                <div>
                  Do <strong>not</strong> set object inputs as HTML attributes — they will be
                  treated as strings
                </div>
              </div>
            </div>
        ...
        <section id="next" class="gs-section">
          ...
          <div class="next-grid">
            <a
              *ngFor="let n of nextSteps; trackBy: trackByIndex"
              [routerLink]="n.route"
              class="next-card"
            >
              <div>
      ...
      <aside class="otp">
        ...
        <nav class="otp-nav">
          <a
            *ngFor="let s of currentSections; trackBy: trackByIndex"
            class="otp-link"
          ...
          <a
            ...
            role="button"
            (click)="scrollTo('ref')"
            (keydown.enter)="scrollTo('ref')"
            (keydown.space)="scrollTo('ref')"
            >Input / Output Ref</a
          >
          <a
            class="otp-link"
            ...
            role="button"
            (click)="scrollTo('next')"
            (keydown.enter)="scrollTo('next')"
            (keydown.space)="scrollTo('next')"
...
export class GettingStartedComponent implements OnInit {
  ...
  nextSteps = [
    {
      icon: '🧩',
      title: 'App Shell',
      desc: 'Full layout shell with sidebar + header',
      route: '/app-shell',
    },
  ...
  code = {
    ng: {
      npmrc: `//npm.pkg.github.com/:_authToken=YOUR_GITHUB_PAT_HERE
@bhairab-patra:registry=https://npm.pkg.github.com`,

      install: `npm install @bhairab-patra/platform-ui`,

      localBuild: `# Run inside the platform-ui library repo
cd path/to/platform-ui
ng build platform-ui --configuration development`,

      localLink1: `# Run inside dist/platform-ui (the built output folder)
cd path/to/platform-ui/dist/platform-ui
npm link`,

      localLink2: `# Run inside your Angular consumer app
cd path/to/your-angular-app
npm link @bhairab-patra/platform-ui`,

      preserveSymlinks: `// angular.json  — add inside architect > build > options
"options": {
  ...
  ...
      ...
      stylesLocal: `// angular.json  — inside architect > build > options ONLY.
...
"architect": {
  "build": {
    "options": {
      ...
      localServe: `# Inside your Angular consumer app
cd path/to/your-angular-app
npm start`,

      localDaily: `# Inside the platform-ui library repo — rebuild after every change
ng build platform-ui --configuration development
# Then just refresh the browser in your Angular app`,

      localWatch: `# Run in a separate terminal — rebuilds on every file save
ng build platform-ui --configuration development --watch`,

      clearCache: `# Inside your Angular consumer app (use Git Bash)
rm -rf .angular
npm start`,
...
skip: [
  ...
  '@bhairab-patra/platform-ui',   // ← add this line
      ...
      styles: `// angular.json  — inside architect > build > options ONLY.
// Do NOT add this to architect > test > options — that array only
// affects "ng test" and has zero effect on "ng serve" / "ng build".
"architect": {
  "build": {
    "options": {
      ...
      standalone: `// app.component.ts  (or any standalone component)
import {
  PuiButtonComponent,
  PuiCardComponent,
  PuiBadgeComponent,
...
export class AppComponent {}`,
      ...
      ngModule: `// app.module.ts  (NgModule-based app)
import {
  PuiButtonComponent,
  PuiCardComponent,
  PuiAppShellComponent,
...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    provideRouter(routes),
      ...
      routes: `// app.routes.ts  — lazy-load each page component
...
npx ng build elements --configuration production`,
      ...
      localElementsBuild: `# Inside the platform-ui library repo
npx ng build elements --configuration production`,

      localVite: `// vite.config.js — in your React app
...
export default defineConfig({
  plugins: [
    react(),
    {
      ...
      localHtml: `<!-- index.html — inside <head> -->
...
<script src="/pui-elements.js"></script>`,
      ...
      propFix: `// ✅ Correct — pass arrays/objects as JSON string attributes
...
<script src="node_modules/@bhairab-patra/platform-ui/elements/main.js"></script>`,
      ...
      mainJsx: `// src/main.jsx  (or main.tsx)
...
declare global {
  namespace JSX {
    interface IntrinsicElements {
      ...
      tsconfig: `// tsconfig.json  — add pui.d.ts to include array
{
...
export default function App() {
  ...
  return (
    <pui-lib-app-shell
      ...
      events: `// src/App.jsx — event handling via addEventListener inside useEffect
import { useRef, useEffect, useState } from 'react'
...
@bhairab-patra:registry=https://npm.pkg.github.com`,
      ...
      install: `# Initialise package.json (only needed once)
npm init -y
