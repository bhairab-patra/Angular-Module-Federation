...
<script>
  ...
  xfwRows = [
    ...
    { name: 'size', angular: 'size="lg"', attr: 'size="lg"', js: 'el.size = "lg"' },
    {
      ...
      angular: '[closeOnBackdrop]="false"',
      attr: 'close-on-backdrop="false"',
      js: 'el.closeOnBackdrop = false',
    },
  ...
  api: ApiRow[] = [
    {
      ...
      type: 'boolean',
      default: 'false',
      description: 'Controls visibility — set to true to show, false to hide.',
    },
    { input: 'title', type: 'string', default: `'Dialog'`, description: 'Header title text.' },
    {
      ...
      type: `'sm'|'md'|'lg'`,
      default: `'md'`,
      description: 'Dialog width — sm 360px Â· md 520px Â· lg 720px.',
    },
    {
    ...
    },
    {
      ...
      default: '—',
      description: 'Fires when backdrop or ✕ is clicked — sync your state here.',
    },
  ];
