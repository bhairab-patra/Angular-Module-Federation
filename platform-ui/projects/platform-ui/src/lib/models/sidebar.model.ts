...
export interface SidebarTheme {
  ...
  activeBorder?:  string;   // active left accent color    default: var(--pui-brand)
  ...
  avatarBg?:      string;   // user avatar background      default: var(--pui-brand)
}
...
export const SIDEBAR_THEMES: Record<string, SidebarTheme> = {
  dark: {
    ...
    activeBg: 'rgba(255,255,255,.08)', activeBorder: 'var(--pui-brand)',
  ...
  slate: {
    ...
    activeBg: 'rgba(255,255,255,.10)', activeBorder: 'var(--pui-brand)',
  ...
  light: {
    ...
    activeBg: '#f0fdfb', activeBorder: 'var(--pui-brand)',
  ...
  solifi: {
    ...
    subitemBg: 'rgba(0,0,0,.12)', avatarBg: 'var(--pui-brand)',
  },
  brand: {
